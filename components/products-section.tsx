...
export function ProductsSection() {
  ...
  const byCategory = (cat: Product["category"]) =>
    products
      ...
      .sort((a, b) => (a.status === "activo" && b.status !== "activo" ? -1 : a.status !== "activo" && b.status === "activo" ? 1 : 0))
  const quesos = byCategory("quesos")
  const carnicos = byCategory("carnicos")
  const otros = byCategory("otros")
